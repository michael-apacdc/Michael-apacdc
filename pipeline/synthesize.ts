...
5. 如果新增新闻数量很少或缺失某个地区的新闻(可能是因为近期该地区新闻已在往日报告中报道过、今天没有新增内容),如实在对应板块说明"近期未发现该地区的新增新闻",不要编造,也不要把往日报道过的旧内容当成新内容重新讲一遍。
6. 排版格式(重要,必须严格按下面的两层列表结构,不要把多条新闻用分号或逗号挤在同一行):
